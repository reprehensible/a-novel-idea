# Promises Ledger — Setups and Payoffs

> Every gun on every mantel. Update after EVERY chapter: plants confirmed
> (PLANNED → OPEN once actually on page), payoffs marked. Before drafting
> Part V, audit: nothing OPEN may remain unaddressed — resolve it or mark it
> INTENTIONALLY-UNRESOLVED with a note (sequel space is legitimate but must
> be chosen, not forgotten).
>
> Statuses: PLANNED (in outline, not yet drafted) / OPEN (planted on page) /
> PAID / INTENTIONALLY-UNRESOLVED.
...
| P006 | "Pressing to the wick" — named and refused | ch 27 | ch 35 (frost-scars) | ch 69 (Serel chooses it) | — | PLANNED |
| P007 | The Three Trues of graving | ch 35 | ch 39 (consistency's price shown) | ch 66–67 (checked against Joss) | — | PLANNED |
| P008 | Caul's unnamed promise taken from Joss | ch 38 | — | INTENTIONALLY-UNRESOLVED in bk 1 (sequel) — log exact wording at drafting | — | PLANNED |
| P009 | Sarich's graving: what it took, the daughter | ch 6 (dressed wrong) | ch 21 (coat), ch 49 (story) | ch 61 (stands down; audit reached) | — | PLANNED |
| P010 | Sarich's deniable mercies (warning slip; wrong degree) | ch 45 | ch 52 | ch 61 (recontextualized) + sequel thread (walks into deeps; pocketed frost ch 39) | — | PLANNED |
| P011 | The Lector's doubt excised | ch 42 | ch 45, 59, 64 (register shifts) | ch 70 (cannot comprehend refusal), ch 71 (cannot see the Archon truly) | — | PLANNED |
| P012 | Cael's true journal | ch 22 (second set) | ch 36, 51 echo | ch 53 (evidence), ch 68 (anchor), ch 74 (testimony) | — | PLANNED |
| P013 | The Latch is cold / grows colder toward Ancarel | ch 16 | ch 46 | ch 54 (compass) | — | PLANNED |
| P014 | Marsh's journal: "wrong about the price" | ch 5, 16 | ch 43 | ch 66 (the price, understood in full) | — | PLANNED |
...
| P024 | Serel's slate-book | ch 15 | — | ch 73+ (left to Renna) | — | PLANNED |
| P025 | The wrong stars over the deep Scald | ch 46 | — | INTENTIONALLY-UNRESOLVED (do not explain in bk 1) | — | PLANNED |

## Audit notes

- Pre-Part-V audit happens after ch 62's bookkeeping: walk this table top to
  bottom; every PLANNED that should have become OPEN must be verified
  against actual drafted prose (an unplanted plant is a bug in the outline
  or the chapter — fix one).
- New promises discovered during drafting get the next P-number; never reuse.
